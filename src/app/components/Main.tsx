...
export default function Main() {
  ...
  return (
    ...
    <header className='header flex  justify-center items-center flex-col-reverse sm:flex-row-reverse md:flex-row-reverse lg:flex-row-reverse xl:flex-row-reverse'>
